CoolClock.config.skins = {
	...
	classic/*was gIG*/: {
		outerBorder:      { lineWidth: 185, radius: 2, color: "#FFFFFF", alpha: 1 },
		smallIndicator:   { lineWidth: 0, startAt: 89, endAt: 94, color: "#3366CC", alpha: 1 },
		largeIndicator:   { lineWidth: 0, startAt: 83, endAt: 94, color: "#3366CC", alpha: 1 },
    ...
    sap_clock: {
		outerBorder:      { lineWidth: 185, radius: 1,color: "red", alpha: 1 },
		smallIndicator:   { lineWidth: 10, startAt: 90, endAt: 94, color: "#3366CC", alpha: 1 },
		largeIndicator:   { lineWidth: 10, startAt: 90, endAt: 94, color: "#3366CC", alpha: 1 },
		hourHand:         { lineWidth: 8, startAt: 0, endAt: 60, color: "white", alpha: 1 },
		minuteHand:       { lineWidth: 8, startAt: 0, endAt: 80, color: "white", alpha: 1 },
